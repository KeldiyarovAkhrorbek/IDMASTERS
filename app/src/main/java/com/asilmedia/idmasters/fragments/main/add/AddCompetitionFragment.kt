package com.asilmedia.idmasters.fragments.main.add
...
import com.masters.idmasters.databinding.FragmentAddCompetitionBinding

class AddCompetitionFragment : Fragment() {

    private lateinit var binding: FragmentAddCompetitionBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAddCompetitionBinding.inflate(inflater, container, false)
        initializeVariables()
        binding.apply {
            ...
            mcvPut.setOnClickListener {
                if (isValid()) {
                    ...
                    competition.id = "$mills"
                    firestore.collection("competitions").document("$mills").set(competition)
